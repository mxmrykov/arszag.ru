                    ...
                    <div className="detailing-table-price">
                        ...
                        <table id="price-list-detailing-table">
                            ...
                            <tr>
                                ...
                                <td rowSpan="3">оклейка окон
                                    <div>металлизированной тонирующей пленкой<br></br>
                                        <div>(5,15,20,30,35,50%)<br></br></div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>нанесение долговечного гидрофобного покрытия на все остекление и панорамную крышу
                                </td>
                            ...
                            <tr>
                                <td style={{borderLeft: 'unset'}}>чёрная полиуретановая пленка на корпус боковых
                                    зеркал
                                </td>
                            ...
                            <tr>
                                <td style={{borderLeft: 'unset'}}>подготовка лкп к нанесению керамичсеких покрытий и
                                    пленки
                                </td>
                            ...
                            <tr>
                                <td colspan="3" style={{borderRight: 'unset', borderLeft: 'unset'}}>комплексная оклейка
                                    защитной пленкой лкп:
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3" style={{borderRight: 'unset', borderLeft: 'unset'}}>комплексная оклейка
                                    защитной пленкой лкп зон риска:
                                </td>
                            </tr>
                            <tr>
                                <td style={{borderLeft: 'unset'}}>категория а</td>
                                <td style={{borderBottom: 'unset'}} rowspan="5">частичная оклейка автомобиля в защитную
                                    полиуретановую пленку для предотвращения появления сколов и царапин на лкп(передний
                                    бампер, передние крылья, капот,боковые зеркала, стойки лобового стекла,
                                    <div>проемы под ручками дверей)<br></br></div>
                                </td>
                    ...
                    <div className="moika-table-price">
                        ...
                        <table id="price-list-washing-table" cellpading>
                            ...
                            <tr>
                                ...
                                <td>трехфазная мойка кузова, ковриков, влажная уборка и пылесос в салоне, турбосушка
                                    горячим воздухом, протирка безопасной микрофиброй, чернение резины
                                </td>
                            ...
                            <tr>
                                ...
                                <td>трехфазная мойка кузова с использованием кисточки в труднодоступных местах, чистка
                                    дисков, турбосушка горячим воздухом,протирка безопасной микрофиброй,чернение резины
                                </td>
                            ...
                            <tr>
                                ...
                                <td>влажная уборка, пылесос салона, деликатная чистка воздуховодов и удаление пыли из
                                    щелей в торпеде
                                </td>
                                <td>1<span style={{marginRight: 5}}></span>700</td>
                                <td>1<span style={{marginRight: 5}}></span>800</td>
                            ...
                            <tr>
                                ...
                                <td>детейлинг мойка кузова, детейлинг уборка салона, химчистка колес, уборка в
                                    багажнике
                                </td>
                            ...
                            <tr>
                                ...
                                <td colSpan="4" style={{borderRight: 'unset'}}>от 1<span
                                    style={{marginRight: 5}}></span>000
                                </td>
                            </tr>
                            <tr>
                                <td style={{borderLeft: 'unset'}}>антидождь передней сферы</td>
                                <td>нанесение долговечного гидрофобного покрытия на переднее остекление (лобовое стекло
                                    и боковые стекла)
                                </td>
                                <td colSpan="4" style={{borderRight: 'unset'}}>4<span style={{marginRight: 5}}></span>000
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colSpan="4" style={{borderRight: 'unset'}}>7<span style={{marginRight: 5}}></span>000
                                </td>
                            </tr>
                            {/* <tr>
                            ...
                            <tr>
                                ...
                                <td colSpan="3" style={{borderRight: 'unset'}}>6<span style={{marginRight: 5}}></span>000
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colSpan="3" style={{borderRight: 'unset'}}>13<span style={{marginRight: 5}}></span>000
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table id="price-list-washing-table" cellpading>
                            ...
                            <tr>
                                <td style={{borderLeft: 'unset'}}>безопасная химчистка двигателя</td>
                                <td>мойка моторного отсека, сушка горячим воздухом, консервация пластиковых элементов
                                </td>
                            ...
                            <tr>
                                ...
                                <td>бесконтактная мойка днища производится с применением специальной насадки, химии и
                                    высокого давления
                                </td>
                                <td>1<span style={{marginRight: 5}}></span>700</td>
                                <td>1<span style={{marginRight: 5}}></span>800</td>
                            ...
                            <tr>
                                ...
                                <td>бесконтактная мойка арок и подвески производится с применением специальной насадки,
                                    химии и высокого давления
                                </td>
                                <td>1<span style={{marginRight: 5}}></span>700</td>
                                <td>1<span style={{marginRight: 5}}></span>800</td>
                                <td>2<span style={{marginRight: 5}}></span>000</td>
                ...
                <section className="pricelist_globalsection non_bottomed">
                    ...
                    <table id="price-list-shin-table">
                        ...
                        <tr>
                            ...
                            <td>уникальная услуга по диагностике шины. проверяется однородность шины, боковой увод, а
            ...
            <section className="App">
                ...
                <section className="pricelist_globalsection">
                    ...
                    <table id="price-list-shin-table">
                        ...
                        <tr>
                            <td style={{borderLeft: 'unset'}}>Детейлинг чистка сидений из кожи</td>
                            <td>Чистка и увлажняющая пропитка кожи на сидениях (переднее водительское, переднее
                                пассажирское и задний диван)
                            </td>
                            <td>8<span style={{marginRight: 5}}></span>000</td>
                        ...
                        <tr>
                            ...
                            <td colSpan="4" style={{borderRight: 'unset'}}>от 2<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>Химчистка руля из алькантары</td>
                            <td>Чистка алькантары на рулевом колесе</td>
                            <td colSpan="4" style={{borderRight: 'unset'}}>от 3<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        {/* */}
                        </tbody>
                    ...
                    <table id="price-list-shin-table">
                        ...
                        <tr>
                            <td style={{borderLeft: 'unset'}}>химчистка передних кресел</td>
                            <td>чистка тканевых передних кресел автомобиля с применением химии и специального
                                инструмента
                            </td>
                        ...
                        <tr>
                            <td style={{borderLeft: 'unset'}}>химчистка заднего дивана</td>
                            <td>чистка тканевого заднего дивана автомобиля с применением химии и специального
                                инструмента
                            </td>
                            <td>4<span style={{marginRight: 5}}></span>000</td>
                            <td>4<span style={{marginRight: 5}}></span>500</td>
                        ...
                        <tr>
                            <td style={{borderLeft: 'unset'}}>химчистка напольных ковриков</td>
                            <td>чистка велюровых напольных ковриков автомобиля с применением химии и специального
                                инструмента
                            </td>
                            <td colSpan="4" style={{borderRight: 'unset'}}>от 4<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>химчистка багажного отделения</td>
                            <td>чистка багажного отделения автомобиля с применением химии и специального инструмента
                            </td>
                            <td>3<span style={{marginRight: 5}}></span>500</td>
                            <td>4<span style={{marginRight: 5}}></span>000</td>
                            <td>4<span style={{marginRight: 5}}></span>500</td>
                        ...
                        <tr>
                            ...
                            <td style={{borderRight: 'unset', borderBottom: 'unset'}}>3<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        </tbody>
                ...
                <section className="pricelist_globalsection">
                    ...
                    <table id="price-list-shin-table">
                        ...
                        <tr>
                            ...
                            <td width="60%">оклейка лобового стекла в прочную защитную пленку для предотвращения сколов
                                и царапин
                            </td>
                            <td width="20%" style={{borderRight: 'unset'}}>от 25<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>защита фар или фонарей</td>
                        ...
                        <tr>
                            ...
                            <td>оклейка боковых зеркал в прочную защитную пленку для предотвращения сколов и царапин
                            </td>
                            <td style={{borderRight: 'unset'}}>от 6<span style={{marginRight: 5}}></span>000</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style={{borderLeft: 'unset'}}>категория а</td>
                            <td rowSpan="5">полная оклейка автомобиля в защитную полиуретановую пленку для
                                предотвращения появления сколов и царапин на лкп (передний бампер, передние крылья,
                                капот, боковые зеркала. двери, пороги, задние крылья, дверь багажника, задний бампер,
                        ...
                        <tr>
                            <td style={{borderLeft: 'unset'}}>категория в</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 245<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>категория с</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 260<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>категория d</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 270<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>категория g</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 370<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style={{borderBottom: 'unset'}} rowspan="5">частичная оклейка автомобиля в защитную
                                полиуретановую пленку для предотвращения появления сколов и царапин на лкп(передний
                                бампер, передние крылья, капот,боковые зеркала, стойки лобового стекла, проемы под
                                ручками дверей)
                            </td>
                        ...
                        <tr>
                            <td style={{borderLeft: 'unset'}}>категория в</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 105<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>категория с</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 110<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style={{borderLeft: 'unset'}}>категория d</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 125<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderBottom: 'unset', borderLeft: 'unset'}}>категория g</td>
                            <td style={{borderRight: 'unset', borderBottom: 'unset'}} className="notachild">от 170<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        </tbody>
                    ...
                    <table id="price-list-shin-table">
                        ...
                        <tr>
                            ...
                            <td width="20%" style={{borderRight: 'unset'}}>от 20<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>антихром ручек дверей</td>
                    ...
                    <table id="price-list-shin-table">
                        ...
                        <tr>
                            ...
                            <td width="60%" rowSpan="3">оклейка окон металлизированной тонирующей пленкой
                                (5,15,20,30,35,50%)
                            </td>
                            <td width="20%" style={{borderRight: 'unset'}}>от 12<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>тонировка боковых окон</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 7<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>тонировка лобового стекла</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 6<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="20%" style={{borderRight: 'unset'}}>от 24<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>тонировка боковых окон</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 14<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>тонировка лобового стекла</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 12<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table id="price-list-shin-table">
                        ...
                        <tr>
                            ...
                            <td width="20%" style={{borderRight: 'unset'}}>от 16<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>оклейка боковых окон</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 10<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>оклейка лобового стекла</td>
                            <td style={{borderRight: 'unset'}} className="notachild">от 9<span
                                style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        </tbody>
                ...
                <section className="pricelist_globalsection non_bottomed">
                    ...
                    <table id="price-list-shin-table">
                        ...
                        <tr>
                            ...
                            <td width="50%" rowSpan="2" style={{borderTop: 'unset', borderLeft: 'unset'}}
                                className="notachild">Описание
                            </td>
                            <td width="25%" colSpan="5" style={{borderTop: 'unset', borderRight: 'unset'}}>Категория
                            </td>
                        </tr>
                        <tr>
                            <td>1</td>
                        ...
                        <tr>
                            ...
                            <td colSpan="3" style={{borderRight: 'unset'}}>31<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colSpan="3" style={{borderRight: 'unset'}}>22<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>Полировка одного элемента</td>
                            <td>удаление царапин с одного элемента автомобиля</td>
                            <td colSpan="5" style={{borderRight: 'unset'}}>от 3<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <section className="pricelist_globalsection">
                    ...
                    <table id="price-list-shin-table">
                        ...
                        <tr>
                            ...
                            <td width="30%" rowSpan="2" style={{borderTop: 'unset', borderLeft: 'unset'}}
                                className="notachild">Описание
                            </td>
                            <td width="40%" colSpan="5" style={{borderTop: 'unset', borderRight: 'unset'}}>Категория
                            </td>
                        </tr>
                        <tr>
                            <td>1</td>
                        ...
                        <tr>
                            ...
                            <td>Комплексная мойка, деконтаминация кузова, очистка глиной (после полировки не
                                требуется)
                            </td>
                            <td colSpan="2" style={{textAlign: "center"}}>5<span style={{marginRight: 5}}></span>000
                            </td>
                            <td colSpan="3" style={{borderRight: 'unset'}}>6<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td rowSpan="3">шикарный блеск, мощный гидрофоб и защита от органических загрязнений (смола,
                                насекомые) на срок от 1 до 2-ух лет
                            </td>
                        ...
                        <tr>
                            ...
                            <td style={{textAlign: "center"}} className="notachild">30<span
                                style={{marginRight: 5}}></span>000
                            </td>
                            ...
                            <td colSpan="3" style={{borderRight: 'unset'}}>38<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>керамика ServFaces 3 слоя</td>
                            <td style={{textAlign: "center"}} className="notachild">36<span
                                style={{marginRight: 5}}></span>000
                            </td>
                            ...
                            <td colSpan="3" style={{borderRight: 'unset'}}>44<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>жидкое стекло ServFaces Sueve 1 слой (ЛКП,ПЛЕНКА)</td>
                            <td>шикарный блеск, мощный гидрофоб и защита от органических загрязнений (смола, насекомые)
                                на срок от 6 месяцев до 1.5 лет
                            </td>
                            <td style={{textAlign: "center"}}>15<span style={{marginRight: 5}}></span>000</td>
                            <td style={{textAlign: "center"}}>17<span style={{marginRight: 5}}></span>000</td>
                            ...
                            <td colSpan="3" style={{borderRight: 'unset'}}>23<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        {/* <tr>
                                <td style={{ borderLeft: 'unset' }}>жидкое стекло ServFaces Sueve 1 слой (ЛКП,ПЛЕНКА)</td>
                        ...
                        <tr>
                            ...
                            <td colSpan="3" style={{borderRight: 'unset'}}>6<span style={{marginRight: 5}}></span>500
                            </td>
                        </tr>
                        <tr>
                            <td style={{borderLeft: 'unset'}}>Твёрдый воск</td>
                            ...
                            <td style={{textAlign: "center"}}>12<span style={{marginRight: 5}}></span>000</td>
                            <td style={{textAlign: "center"}}>13<span style={{marginRight: 5}}></span>000</td>
                            <td colSpan="3" style={{borderRight: 'unset'}}>14<span style={{marginRight: 5}}></span>000
                            </td>
                        </tr>
                        </tbody>
                    </table>
